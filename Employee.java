...
public class Employee {
	...
	public void toString(Employee employee) {
		...
		System.out.println("Vergi ve bonuslar ile maaş: "+(salary-employee.tax()+employee.bonus()));
		System.out.println("Toplam maaş: "+(salary+employee.raiseSalary()-employee.tax()+employee.bonus()));
	}
